...
<?php echo $this->Form->create('Generale', array('action' => 'add')); ?>
<div class="modal-body">
    <div class="form-group">
        <div class="row">
            <div class="col-sm-12">
                <label class="control-label">Nombre</label>
                <?php echo $this->Form->text('nombre', array('class' => 'form-control', 'required', 'placeholder' => 'Ingrese el nombre del dato general')); ?>         
            </div>
        </div>
    </div>
    <div class="form-group">
